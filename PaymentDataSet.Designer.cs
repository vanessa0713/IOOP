...
namespace assignment_receptionist {
    ...
    public partial class PaymentDataSet : global::System.Data.DataSet {
        ...
        public partial class PaymentDataTable : global::System.Data.TypedTableBase<PaymentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public PaymentRow AddPaymentRow(int paymentID, string paymentStatus, System.DateTime date, System.TimeSpan time, double Amount, int customerID, string paymentDetail) {
            ...
            private void InitClass() {
                ...
                this.columnpaymentDetail.MaxLength = 2147483647;
            }
        ...
        public partial class PaymentRow : global::System.Data.DataRow {
            ...
            public System.DateTime date {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("表“Payment”中列“date”的值为 DBNull。", e);
                    }
                }
                set {
            ...
            public System.TimeSpan time {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("表“Payment”中列“time”的值为 DBNull。", e);
                    }
                }
                set {
            ...
            public int customerID {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("表“Payment”中列“customerID”的值为 DBNull。", e);
                    }
                }
                set {
            ...
            public string paymentDetail {
                get {
                    try {
                        return ((string)(this[this.tablePayment.paymentDetailColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("表“Payment”中列“paymentDetail”的值为 DBNull。", e);
                    }
                }
                set {
                    this[this.tablePayment.paymentDetailColumn] = value;
                }
            }
            ...
            public bool IspaymentDetailNull() {
                return this.IsNull(this.tablePayment.paymentDetailColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetpaymentDetailNull() {
                this[this.tablePayment.paymentDetailColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace assignment_receptionist.PaymentDataSetTableAdapters {
    ...
    public partial class PaymentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Payment] WHERE (([paymentID] = @Original_paymentID) AND ([paymentStatus] = @Original_paymentStatus) AND ((@IsNull_date = 1 AND [date] IS NULL) OR ([date] = @Original_date)) AND ((@IsNull_time = 1 AND [time] IS NULL) OR ([time] = @Original_time)) AND ([Amount] = @Original_Amount) AND ((@IsNull_customerID = 1 AND [customerID] IS NULL) OR ([customerID] = @Original_customerID)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Payment] ([paymentID], [paymentStatus], [date], [time], [Amount], [customerID], [paymentDetail]) VALUES (@paymentID, @paymentStatus, @date, @time, @Amount, @customerID, @paymentDetail);
SELECT paymentID, paymentStatus, date, time, Amount, customerID, paymentDetail FROM Payment WHERE (paymentID = @paymentID)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@paymentDetail", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "paymentDetail", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Payment] SET [paymentID] = @paymentID, [paymentStatus] = @paymentStatus, [date] = @date, [time] = @time, [Amount] = @Amount, [customerID] = @customerID, [paymentDetail] = @paymentDetail WHERE (([paymentID] = @Original_paymentID) AND ([paymentStatus] = @Original_paymentStatus) AND ((@IsNull_date = 1 AND [date] IS NULL) OR ([date] = @Original_date)) AND ((@IsNull_time = 1 AND [time] IS NULL) OR ([time] = @Original_time)) AND ([Amount] = @Original_Amount) AND ((@IsNull_customerID = 1 AND [customerID] IS NULL) OR ([customerID] = @Original_customerID)));
SELECT paymentID, paymentStatus, date, time, Amount, customerID, paymentDetail FROM Payment WHERE (paymentID = @paymentID)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@paymentDetail", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "paymentDetail", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT paymentID, paymentStatus, date, time, Amount, customerID, paymentDetail FR" +
                "OM dbo.Payment";
        ...
        public virtual int Delete(int Original_paymentID, string Original_paymentStatus, global::System.Nullable<global::System.DateTime> Original_date, global::System.Nullable<global::System.TimeSpan> Original_time, double Original_Amount, global::System.Nullable<int> Original_customerID) {
            ...
            if ((Original_paymentStatus == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[1].Value = ((string)(Original_paymentStatus));
            }
        ...
        public virtual int Insert(int paymentID, string paymentStatus, global::System.Nullable<global::System.DateTime> date, global::System.Nullable<global::System.TimeSpan> time, double Amount, global::System.Nullable<int> customerID, string paymentDetail) {
            ...
            if ((paymentDetail == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[6].Value = ((string)(paymentDetail));
            }
        ...
        public virtual int Update(int paymentID, string paymentStatus, global::System.Nullable<global::System.DateTime> date, global::System.Nullable<global::System.TimeSpan> time, double Amount, global::System.Nullable<int> customerID, string paymentDetail, int Original_paymentID, string Original_paymentStatus, global::System.Nullable<global::System.DateTime> Original_date, global::System.Nullable<global::System.TimeSpan> Original_time, double Original_Amount, global::System.Nullable<int> Original_customerID) {
            ...
            if ((paymentDetail == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[6].Value = ((string)(paymentDetail));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string paymentStatus, global::System.Nullable<global::System.DateTime> date, global::System.Nullable<global::System.TimeSpan> time, double Amount, global::System.Nullable<int> customerID, string paymentDetail, int Original_paymentID, string Original_paymentStatus, global::System.Nullable<global::System.DateTime> Original_date, global::System.Nullable<global::System.TimeSpan> Original_time, double Original_Amount, global::System.Nullable<int> Original_customerID) {
            return this.Update(Original_paymentID, paymentStatus, date, time, Amount, customerID, paymentDetail, Original_paymentID, Original_paymentStatus, Original_date, Original_time, Original_Amount, Original_customerID);
        }
    }
